    ...
    <div class="container">
      <div class="poca-projects-menu mb-30 wow fadeInUp" data-wow-delay="0.3s">
        <div class="text-center portfolio-menu">
          ...
          <button class="btn" data-filter=".entre">Entreprenurship</button>
				...
				<div class="col-12 col-md-6 single_gallery_item entre wow fadeInUp" data-wow-delay="0.2s">
					...
					<div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
						...
						<div class="poca-music-content text-center">
							...
							<h2><?php the_title(); ?></h2>
							<div class="music-meta-data">
								<p>By <a href="#" class="music-author"><?php the_author(); ?></a> | <a href="#" class="music-catagory"><?php the_category('<a href="#" class="music-catagory"></a>'); ?></a> | <a href="#" class="music-duration"><?php the_time(); ?></a></p>
							</div>
							<!-- Music Player -->
							<div class="poca-music-player">
								<audio preload="auto" controls>
